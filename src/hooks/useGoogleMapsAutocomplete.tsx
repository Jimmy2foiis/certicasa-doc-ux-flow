...
}: UseGoogleMapsAutocompleteOptions) {
  ...
  useEffect(() => {
    const loadGoogleMapsScript = () => {
      ...
      if (!document.getElementById('google-maps-script')) {
        ...
        script.src = `https://maps.googleapis.com/maps/api/js?key=AIzaSyBoHmcKb2Bgf1PUxNTnsTAjMa0RgYx-HoQ&libraries=places&callback=initGoogleMapsAutocomplete&v=weekly`;
        script.async = true;
        script.defer = true;

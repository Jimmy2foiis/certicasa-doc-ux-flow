...
interface CherryOptionProps {
  ...
  onCherryChange: (checked: boolean) => void;
  pricePerSqm: number;
  projectPrice: number;
}

const CherryOption = ({ cherryEnabled, onCherryChange, pricePerSqm, projectPrice }: CherryOptionProps) => {
    ...
    <>
      ...
      <div className="flex items-center space-x-2 pt-2">
        <Checkbox
          ...
          onCheckedChange={(checked) => onCherryChange(checked === true)}
        />

...
const DocumentsTabContent = ({
  ...
  return <CardContent>
      <Alert className="mb-4">
        ...
        <AlertDescription>8 documents sont obligatoires pour la validation du dossier CAE. Cliquez sur chaque ligne pour voir l'aperçu et les actions disponibles.</AlertDescription>
      </Alert>

      <DocumentsWithDragDrop documents={requiredDocuments} isLoading={isLoading} onAction={onAction} onRefresh={onRefresh} />
    </CardContent>;
};

    ...
    <Card>
      ...
      <CardContent>
        <div className="flex flex-col gap-4">
          ...
          <TemplateUploadArea uploading={uploading} onChange={handleFileUpload} />
        ...
        <AlertDialog open={!!fileToDelete} onOpenChange={cancelDelete}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                Êtes-vous sûr de vouloir supprimer ce modèle ? Cette action ne peut pas être
                annulée.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
        ...
        <CardFooter>
          <div className="w-full flex justify-between items-center">
            <p className="text-sm text-gray-500">
              ...
              {uploadedFiles.filter((f) => f.status === 'complete').length} prêt(s) à
              l'enregistrement
            </p>
            <Button
